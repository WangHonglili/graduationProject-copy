import{_ as s,o as a,c as n,Q as l}from"./chunks/framework.7427aee3.js";const A=JSON.parse('{"title":"配置","description":"","frontmatter":{},"headers":[],"relativePath":"guide/configure.md"}'),p={name:"guide/configure.md"},e=l(`<h1 id="配置" tabindex="-1">配置 <a class="header-anchor" href="#配置" aria-label="Permalink to &quot;配置&quot;">​</a></h1><h2 id="环境配置" tabindex="-1">环境配置 <a class="header-anchor" href="#环境配置" aria-label="Permalink to &quot;环境配置&quot;">​</a></h2><p>默认提供三套环境配置，分别为：</p><div class="vp-code-group"><div class="tabs"><input type="radio" name="group-qq4jI" id="tab-KxOw6i8" checked="checked"><label for="tab-KxOw6i8">.env.development 开发环境</label><input type="radio" name="group-qq4jI" id="tab-3sr5eEZ"><label for="tab-3sr5eEZ">.env.test 测试环境</label><input type="radio" name="group-qq4jI" id="tab-echrnxc"><label for="tab-echrnxc">.env.production 生产环境</label></div><div class="blocks"><div class="language-yaml active"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;"># 页面标题</span></span>
